...
class EnthusiastRegisterView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_enthusiast_register_view)
        ...
        backBtn.setOnClickListener {
            ...
            dbHelper.deleteUser("admin")
            dbHelper.deleteUser("admin1")
